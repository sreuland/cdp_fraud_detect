...
from python_app.kafka_config import KAFKA_BOOTSTRAP_SERVERS, KAFKA_FRAUD_TOPIC
from python_app.kafka_consumer import start_kafka_consumer
from python_app.models import User, FraudEvent
from python_app.oauth import router as oauth_router
from python_app.oauth_utils import get_current_user
